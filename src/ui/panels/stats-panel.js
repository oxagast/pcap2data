...
const MAX_HEATMAP_MAP_ZOOM = 2500;
...
const WIKIMEDIA_WORLD_MAP_PROJECTION_ZOOM_X = MAP_PROJECTION_CALIBRATION.zoomX;
const WIKIMEDIA_WORLD_MAP_PROJECTION_ZOOM_Y = MAP_PROJECTION_CALIBRATION.zoomY;
const WIKIMEDIA_WORLD_MAP_PROJECTION_OFFSET_X = MAP_PROJECTION_CALIBRATION.offsetX;
const WIKIMEDIA_WORLD_MAP_PROJECTION_OFFSET_Y = MAP_PROJECTION_CALIBRATION.offsetY;
...
function collectPacketDecodedProtocolNames(packetInfo) {
  ...
  const sectionNames = ["TCP", "UDP", "SCTP", "ICMP", "IGMP", "OSPF", "HSRP", "LACP", "CDP", "STP", "LINK", "IP"];
