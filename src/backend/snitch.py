...
def decodeAddressResolutionPacket(p):
    ...
    section = {
        ...
        "arp.op": opLabel,
        "rarp.op": opLabel,
        "network.rarp": opLabel,
        "network.arp.op": opLabel,
        "Opcode": opCode,
        "arp.opcode": opCode,
        "rarp.opcode": opCode,
        "network.arp.opcode": opCode,
        "network.rarp.opcode": opCode,
        "Sender MAC": srcMac,
        "arp.src.mac": srcMac,
        "rarp.src.mac": srcMac,
        "network.arp.src.mac": srcMac,
        "network.rarp.src.mac": srcMac,
        "Target MAC": dstMac,
        "arp.dst.mac": dstMac,
        "rarp.dst.mac": dstMac,
        "network.arp.dst.mac": dstMac,
        "network.rarp.dst.mac": dstMac,
        "Sender IP": srcIp,
        "arp.src.ip": srcIp,
        "rarp.src.ip": srcIp,
        "network.arp.src.ip": srcIp,
        "network.rarp.src.ip": srcIp,
        "Target IP": dstIp,
        "arp.dst.ip": dstIp,
        "rarp.dst.ip": dstIp,
        "network.arp.dst.ip": dstIp,
        "network.rarp.dst.ip": dstIp,
        "Hardware Type": hwTypeVal,
        "arp.hw.type": hwTypeVal,
        "network.arp.hw.type": hwTypeVal,
        "rarp.hw.type": hwTypeVal,
        "network.rarp.hw.type": hwTypeVal,
        "Protocol Type": f"0x{protoTypeVal:04x}",
        "arp.proto.type": f"0x{protoTypeVal:04x}",
        "network.arp.proto.type": f"0x{protoTypeVal:04x}",
        "rarp.proto.type": f"0x{protoTypeVal:04x}",
        "network.rarp.proto.type": f"0x{protoTypeVal:04x}",
        "Hardware Size": hwSizeVal,
        "arp.hw.size": hwSizeVal,
        "network.arp.hw.size": hwSizeVal,
        "rarp.hw.size": hwSizeVal,
        "network.rarp.hw.size": hwSizeVal,
        "Protocol Size": protoSizeVal,
        "arp.proto.size": protoSizeVal,
        "network.arp.proto.size": protoSizeVal,
        "rarp.proto.size": protoSizeVal,
        "network.rarp.proto.size": protoSizeVal,
        "network.proto": "ARP" if not isRarp else "RARP",
    }
